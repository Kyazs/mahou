---
name: mahou-design-craft
description: Detailed frontend craft reference — color, typography, layout, motion, interaction, critique framework (Nielsen heuristics, cognitive load, personas). Load before the build or critique pass in mahou-designer.
---
